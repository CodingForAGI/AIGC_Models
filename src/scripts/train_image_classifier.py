...
def image_classification_train_pipeline(args):
    ...
    train_dataloader = create_image_classification_dataloader(
        dataset_name=cfg.dataset, batch_size=cfg.batch_size, is_train=True
    )
    test_dataloader = create_image_classification_dataloader(
        dataset_name=cfg.dataset, batch_size=cfg.batch_size, is_train=False
    )
    ...
    task_name = f"{model_name}_{cfg.dataset}_image_classification"
